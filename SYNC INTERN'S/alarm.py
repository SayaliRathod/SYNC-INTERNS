...
print("Set Your Time To Wake You Up! ")
...
def main():
    while True:
        try:
            print("Please select the date you would like the alarm to ring:")
    ...
    while True:
        try:
            print(
                "Please select the time you would like the alarm to ring (24hr clock):")
    ...
    input("Click Enter to stop sound: ")
...
def alarm_countdown(n):
    while True:
        ...
        if n == current_time:
            print("Alarm ringing!!")
            winsound.PlaySound(
                "defaultsound", winsound.SND_ASYNC + winsound.SND_LOOP)
            break
